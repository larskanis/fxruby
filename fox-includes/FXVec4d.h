...
*********************************************************************************
* $Id: FXVec4d.h 2775 2007-11-26 15:45:29Z lyle $                           *
********************************************************************************/
#ifndef FXVEC4D_H
#define FXVEC4D_H
...
public:
  ...
  friend inline FXbool operator==(const FXVec4d& a,FXdouble n);
  friend inline FXbool operator!=(const FXVec4d& a,FXdouble n);
  friend inline FXbool operator==(FXdouble n,const FXVec4d& a);
  friend inline FXbool operator!=(FXdouble n,const FXVec4d& a);
